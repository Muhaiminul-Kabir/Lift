...
<section class="h-100 h-custom" style="background-color: #d2c0ff;">
						...
						<div class="row g-0">
							<div class="col-lg-8">
								<div class="p-5">
									...
									<div class="pt-5">
										<h6 class="mb-0"><a href="list.php" class="text-body"><i class="fas fa-long-arrow-alt-left me-2"></i>Back to shop</a></h6>
									</div>
								</div>
							</div>
							<div class="col-lg-4 bg-grey">
								<div class="p-5">
									...
									<button type="button" id="launch" class="btn btn-dark btn-block btn-lg " data-mdb-ripple-color="dark" >Checkout</button>
